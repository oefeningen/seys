<template>
  <div>
    <scroll-fixed-header v-model="fixed" :threshold="56">
      ...
      <div class="dropdown" :class="{ active: active }">
        <div class="container">
          ...
          <div class="dropdown_inner">
            <ul class="anchor_nav">
              <li class="current">
                <a href="#home" @click="active = !active"> Home </a>
              </li>
              <li>
                <a href="#about" @click="active = !active"> About </a>
              </li>
              <li>
                <a href="#portfolio" @click="active = !active"> Portfolio </a>
              </li>
              <li>
                <a href="#news" @click="active = !active"> News </a>
              </li>
              <li>
                <a href="#contact" @click="active = !active"> Contact </a>
              </li>
              <!-- <li>
                <a
                  class="white-fill-bg btn-outline btn_sm"
